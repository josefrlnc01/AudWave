...
export class DocumentController {
    ...
    static createSRT = async (req, res) => {
        try {
            const { segments } = req.body;
    ...
    static createVTT = async (req, res) => {
        try {
            const { segments } = req.body;
    ...
    static createTXT = async (req, res) => {
        try {
            const { segments } = req.body;
    ...
    static createDOCX = async (req, res) => {
        try {
            const { segments } = req.body;
    ...
    static createJSON = async (req, res) => {
        try {
            ...
            res.setHeader("Content-Disposition", 'attachment; filename="archivo.json"');
    ...
    static createCSV = async (req, res) => {
        try {
            const { segments } = req.body;
