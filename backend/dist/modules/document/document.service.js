...
export class DocumentService {
    static generatePdf = async (segments) => {
    ...
    static generateSrt = async (segments) => {
    ...
    static generateVtt = async (segments) => {
    ...
    static generateTxt = async (segments) => {
    ...
    static generateDocX = async (segments) => {
        const paragraphs = segments.map(seg => new Paragraph({
            spacing: { after: 200 },
            children: [
                new TextRun({
    ...
    static generateJson = async (segments) => {
    ...
    static generateCsv = async (segments) => {
