...
export async function transcribeWhisperAudio(filePath) {
    try {
        ...
        if (!responseText)
            throw new AppError('Error al formatear la transcripción', 400);
        const formattedSegments = JSON.parse(responseText);
