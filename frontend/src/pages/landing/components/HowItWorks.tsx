...
export default function HowItWorks() {
    ...
    useGSAP(() => {
        gsap.to(".howitworks-box", {
            scrollTrigger: {
                trigger: ".howitworks-box",
                start: "top 80%"
            },
            opacity: 1,
            duration: 0.8
    ...
    return (
        <section className="howitworks-box w-full min-w-full p-6 flex flex-col justify-center items-center grow gap-8 md:gap-6 lg:gap-4 opacity-0">
            <aside className="flex flex-col gap-4 mb-10 md:mb-2 lg:mb-0">
                <h2 className="text-2xl md:text-4xl  text-center font-bold text-white">¿Cómo funciona?</h2>
            ...
            <aside className="relative flex p-0 md:p-10 lg:p-14 gap-20 flex-col lg:flex-row justify-between items-startr">
                <div className="flex-1 text-center">
                    ...
                    <h4 className="text-lg md:text-xl font-bold mb-2">Sube tu archivo/Copia tu enlace de Youtube</h4>
                ...
                <div className="flex-1 text-center">
                    ...
                    <h4 className="text-lg md:text-xl font-bold mb-2">Procesamiento IA</h4>
                ...
                <div className="flex-1 text-center">
                    ...
                    <h4 className="text-lg md:text-xl font-bold mb-2">Trabaja con tus documentos</h4>
