    ...
    return (
        <section className="w-screen min-w-screen p-6 flex flex-col justify-center items-center grow gap-4">
            <aside className="flex flex-col gap-4">
                ...
                <p className="max-w-2xl mx-auto text-sm md:text-lg text-gray-500 text-center leading-relaxed">3 pasos para una transcripción perfecta</p>
            </aside>
            <aside className="relative flex p-14 flex-col md:flex-row justify-between items-start">
                ...
                <div className="flex-1 text-center">
                    ...
                    <h4 className="text-xl font-bold mb-2">Sube tu archivo</h4>
                    <p className="text-gray-400 text-sm px-4">Arrastra y suelta MP4, MP3, WAV o M4A directamente en el panel.</p>
                </div>
                ...
                <div className="flex-1 text-center">
                    ...
                    <p className="text-gray-400 text-sm px-4">Nuestra IA Whisper v3 analiza y etiqueta locutores automáticamente.</p>
                </div>
                ...
                <div className="flex-1 text-center">
                    ...
                    <p className="text-gray-400 text-sm px-4">Revisa el texto, traduce si es necesario y descarga en TXT, SRT o VTT.</p>
                </div>
